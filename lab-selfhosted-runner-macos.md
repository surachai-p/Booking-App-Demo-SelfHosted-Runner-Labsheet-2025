...
4. ตั้งชื่อ: `booking-app-demo-selfhosted-runner-2025`
5. คลิก **Create fork**
...
git clone https://github.com/YOUR_USERNAME/booking-app-demo-selfhosted-runner-2025.git

# เข้าไปในโฟลเดอร์
cd booking-app-demo-selfhosted-runner-2025
```
...
pwd
# ควรได้ .../booking-app-demo-selfhosted-runner-2025
```
